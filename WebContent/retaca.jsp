...
<html>
  <form method="post" action="resultaca.jsp">
  <body style="text-align:center;" background="we3.jpg" action="resultaca.jsp">
	    <CENTER>
	    <H2><FONT size="8" COLOR="#800000" FACE="Verdana" >ACA</FONT></H2></CENTER>
	<hr>
      <% 
      try{
...
ResultSet rs=st.executeQuery("Select * from ACA");
int i=1;
while(rs.next()){
%>
