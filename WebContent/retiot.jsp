...
<html>
  <form method="post" action="resultiot.jsp">
  <body style="text-align:center;" background="we3.jpg" action="resultiot.jsp">
	    <CENTER>
	    <H2><FONT size="8" COLOR="#800000" FACE="Verdana" >IOT</FONT></H2></CENTER>
	<hr>
      <% 
      try{
...
ResultSet rs=st.executeQuery("Select * from IOT");
int i=1;
while(rs.next()){
%>
